                          ...
                          <div className="card-body w50 p-3 convenioRes geosansLight">
                            ...
                            <p className="interline1 text-size07 raleway-medium justify">
                                ...
                                La promoción puede ser transferible a un familiar directo (hijo, hija, hermana, papá y mamá), solo presentando el voucher de compra en DIAMANTE PERÚ.<br></br>
                                 ...
                                 Local ubicado en: Av. Javier Prado Este 2456, 3er. Piso - San Borja.<br></br> Horario de atención*: De Lunes a Viernes de 10am a 7pm / Sábados: 10am a 1pm. <br></br>
                                 Teléfono de contacto: 2268364 
                    ...
                    <div className="row">
                      <div className="col-md-12  cont-ben">
                        <div className="mb-2  flex flexWrap">
                          ...
                          ALIANZA COMERCIAL - CARMEN SEMINARIO y CLUB DIAMANTE PERU</h4>

                            <h3 className="card-title">
                            DATOS DE LA ALIANZA  <br/>
                            VIGENCIA: DEL 30 DE ABRIL 2019 AL 30 DE ABRIL 2020</h3>
                            <p className="card-text font-size-1">El establecimiento ofrece:</p>
                            <ul className="interline1 ml-4 font-size-1rem">
