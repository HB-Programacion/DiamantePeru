        ...
        <div className = "w100 animated fadeIn">
            <div className="">
                ...
                <div className="w40 cuadro pt-4 pb-3 pl-5 pr-5">
                    ...
                    <Link to="/blog-sorteo-club-diamante" className="leer-mas-blog mt-4">LEER MÁS<i className="fas fa-chevron-right arrow"></i></Link>
                </div>
                        ...
                        <div className="col-sm-6 col-md-6 mb-5">
                            <div className="card" style={{width: "18 rem"}}>
                                ...
                                <div className="card-body p-3">
                                    ...
                                    <hr className="my-3"/>
                                    <Link to="/blog-club-diamante" className="">LEER MÁS<i className="fas fa-chevron-right arrow"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 mb-5">
                            <div className="card" style={{width: "18 rem"}}>
                                ...
                                <div className="card-body p-3">
                                    ...
                                    <hr className="my-3"/>
                                    <Link to="/blog-evitar-estafa" className="">LEER MÁS<i className="fas fa-chevron-right arrow"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 mb-5">
                            <div className="card" style={{width: "18 rem"}}>
                                ...
                                <div className="card-body p-3">
                                    ...
                                    <hr className="my-3"/>
                                    <Link to="/blog-historia-sortija" className="">LEER MÁS<i className="fas fa-chevron-right arrow"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 mb-5">
                            <div className="card" style={{width: "18 rem"}}>
                                ...
                                <div className="card-body p-3">
                                    ...
                                    <hr className="my-3"/>
                                    <Link to="/color"className="">LEER MÁS<i className="fas fa-chevron-right arrow"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
